...
export default function TextBlock(props: IIcons) {
  return (
    <>
      ...
      <path d="M7 9.63a.75.75 0 01-.34-1.42c3.34-1.67 7.33-1.67 10.67 0 .37.19.52.64.34 1.01a.76.76 0 01-1.01.34 10.485 10.485 0 00-9.33 0c-.1.05-.22.07-.33.07z"></path>
      <path d="M12 17.04c-.41 0-.75-.34-.75-.75V7.93c0-.41.34-.75.75-.75s.75.34.75.75v8.37c0 .41-.34.74-.75.74z"></path>
    </>
  )
}
